...
obj1=Solution()
# print("4",obj1.wonderfulSubstrings("aba"))
# print("9",obj1.wonderfulSubstrings("aabb"))
print("2",obj1.wonderfulSubstrings("abc"))
# print("",obj1.wonderfulSubstrings("caabbc"))
# print("4",obj1.wonderfulSubstrings("aba"))